<div>
         <div id="sidebar-container" class="pr">
             ...
             <div class="menu">
                 ...
                 <a href="maestros.php" class="d-block p-3"><i class="bi bi-people-fill me-2 lead"></i><span>Ingresar maestros</span></a>
                 <a href="horaClase.php" class="d-block p-3"><i class="bi bi-hourglass-split me-2 lead"></i><span>Horas academicas</span></a>
                 <a href="Dias.php" class="d-block p-3"><i class="bi bi-calendar-day me-2 lead"></i><span>Dias Clase</span></a>
                 <a href="Especializaciones.php" class="d-block p-3"><i class="bi bi-bezier me-2 lead"></i><span>Especializaciones de Colegio</span></a>
