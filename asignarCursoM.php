<?php
$title="Asignacion de materias a los cursos";
                  ...
                  <div class="col-lg-8 my-3">
                    <div class="card">
                      <div class="card-header bg-light">
                        <h6 class="font-weight-bold">Asignacion de materias a los cursos</h6>
                      </div>
                      <div class="card-body">
                        ...
                        <div class="container">
                            <form class="row g-3" action="frm.php" method="POST">
                                ...
                                <div class="col-6">
                                    <label for="inputEmail4" class="form-label">tipo del curso</label>
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary" name="CursosAsig1">Guardar</button>
                                </div>
                            </form>
                        </div>
                      </div>
              ...
              <div class="container">
                <div class="row">
                  <div class="col-lg-6 my-3">
                    <div class="card">
                      <div class="card-header bg-light">
                        <h6 class="font-weight-bold">Cursos Vespertinos</h6>
                      </div>
                      <div class="card-body">
                  ...
                  <div class="col-lg-6 my-3">
                    <div class="card">
                      <div class="card-header bg-light">
                        <h6 class="font-weight-bold">Cursos Matutino</h6>
                      </div>
                      <div class="card-body">
                        <!-- <canvas id="myChart"></canvas> -->
